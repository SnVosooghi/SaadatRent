...
if exist "League of Legends.exe" (
	@start "" "League of Legends.exe" "8394" "LoLLauncher.exe" "" "spectator spectator.na2.lol.riotgames.com:80 4ok1JNlOrDrGb7819KT0uh5F8PNgGtWa 3018579278 NA1" "-UseRads" "-Locale=%locale%"
	goto :eof
)
:cannotFind
echo ===================
echo KR: LOL ��θ� �ڵ����� ã�� �� �����ϴ�. ���򸻿��� �����ϱ� ���� �ذ��� ���ø� �ذ� �� �� �ֽ��ϴ�.
echo EN: Cannot found LOL directory path for automatic. Please see our spectate help page: http://na.op.gg/help/observer
echo ===================
@pause
goto :eof<!-- 46.51.72.253 -->